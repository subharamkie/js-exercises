...
describe("findNextNumber", () => {
  ...
  test("Error if number to find is not passed", () => {
    expect(() => {
      findNextNumber([2, 4, 6, 7, 9]);
    }).toThrow("Number to find is required");
  });
});
...
describe("count1sand0s", () => {
  ...
  test("Error if argument is not passed", () => {
    expect(() => {
      count1sand0s();
    }).toThrow("Non empty binary string is required");
  });
...
describe("sumArrays", () => {
  ...
  test("Error if arguments are not passed", () => {
    expect(() => {
      sumArrays();
    }).toThrow("Array of number arrays is required");
  });
});
...
describe("getWordFrequencies", () => {
  ...
  test("Error if argument is not passed", () => {
    expect(() => {
      getWordFrequencies();
    }).toThrow("Non empty string is required");
  });
